...
public class NoteController {
	 ...
	 */
	@ApiOperation(value = "Delete a note by a user")
	...
	@ApiOperation(value = "Delete all notes by a user")
	 ...
	 * method.
	 */
	@ApiOperation(value = "Update a User Note")
	 ...
	 * 
	 */
	@ApiOperation(value = "Retrieve a Note by a User")
